...
<p sourcefile="api/ArcGIS.Desktop.Framework.Contracts.CheckBox.yml" sourcestartlinenumber="1">Represents a check box control. This is an abstract class.</p>


## Object Signature

```csharp
public abstract class CheckBox : Button, INotifyPropertyChanged
```
...
<p sourcefile="api/ArcGIS.Desktop.Framework.Contracts.CheckBox.yml" sourcestartlinenumber="1">Gets or sets whether the <xref href="ArcGIS.Desktop.Framework.Contracts.CheckBox" data-throw-if-not-resolved="false"></xref> is checked.</p>
