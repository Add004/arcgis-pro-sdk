...
```csharp
public sealed class ProjectClosedEvent : CompositePresentationEvent<ProjectEventArgs>
```
...
<p sourcefile="api/ArcGIS.Desktop.Core.Events.ProjectClosedEvent.yml" sourcestartlinenumber="1">Subscribe to the ProjectClosedEvent</p>
...
<p sourcefile="api/ArcGIS.Desktop.Core.Events.ProjectClosedEvent.yml" sourcestartlinenumber="1">Unsubscribe from the ProjectClosedEvent</p>
...
<p sourcefile="api/ArcGIS.Desktop.Core.Events.ProjectClosedEvent.yml" sourcestartlinenumber="1">Unsubscribe the delegate from the ProjectClosedEvent</p>
