...
<p sourcefile="api/ArcGIS.Core.Data.UtilityNetwork.Trace.LoopsTracer.yml" sourcestartlinenumber="1">The LoopsTracer class returns elements that participate in loops.</p>


## Object Signature

```csharp
public class LoopsTracer : Tracer
```
...
<p sourcefile="api/ArcGIS.Core.Data.UtilityNetwork.Trace.LoopsTracer.yml" sourcestartlinenumber="1">Executes a loops trace and exports the results to a json file.</p>
...
<p sourcefile="api/ArcGIS.Core.Data.UtilityNetwork.Trace.LoopsTracer.yml" sourcestartlinenumber="1">The name of the Tracer object</p>
...
<p sourcefile="api/ArcGIS.Core.Data.UtilityNetwork.Trace.LoopsTracer.yml" sourcestartlinenumber="1">Executes a loop trace.</p>
