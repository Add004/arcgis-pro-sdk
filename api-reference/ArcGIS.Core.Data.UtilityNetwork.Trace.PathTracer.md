...
<p sourcefile="api/ArcGIS.Core.Data.UtilityNetwork.Trace.PathTracer.yml" sourcestartlinenumber="1">The PathTracer class performs a path trace.</p>


## Object Signature

```csharp
public sealed class PathTracer : Tracer
```
...
<p sourcefile="api/ArcGIS.Core.Data.UtilityNetwork.Trace.PathTracer.yml" sourcestartlinenumber="1">Executes a path trace and exports the results to a json file.</p>
...
<p sourcefile="api/ArcGIS.Core.Data.UtilityNetwork.Trace.PathTracer.yml" sourcestartlinenumber="1">The name of the Tracer object</p>
...
<p sourcefile="api/ArcGIS.Core.Data.UtilityNetwork.Trace.PathTracer.yml" sourcestartlinenumber="1">Executes a path trace.</p>
