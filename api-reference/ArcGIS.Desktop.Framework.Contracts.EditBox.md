...
<p sourcefile="api/ArcGIS.Desktop.Framework.Contracts.EditBox.yml" sourcestartlinenumber="1">Represents a control that can be used to display and edit strings, doubles, or integers. This is an abstract class.</p>


## Object Signature

```csharp
public abstract class EditBox : PlugIn, INotifyPropertyChanged
```
...
<p sourcefile="api/ArcGIS.Desktop.Framework.Contracts.EditBox.yml" sourcestartlinenumber="1">Called when the 'Enter' key is pressed inside this control or when the control loses keyboard focus.</p>
...
<p sourcefile="api/ArcGIS.Desktop.Framework.Contracts.EditBox.yml" sourcestartlinenumber="1">Invoked when the combo box loses keyboard focus.</p>
...
<p sourcefile="api/ArcGIS.Desktop.Framework.Contracts.EditBox.yml" sourcestartlinenumber="1">Called whenever the text in the control changes.</p>
...
<p sourcefile="api/ArcGIS.Desktop.Framework.Contracts.EditBox.yml" sourcestartlinenumber="1">Gets or sets the text contents of the text box.</p>
